...
it('Teste se a página contém dois parágrafos com texto sobre a Pokédex.', () => {
  ...
  const textParagraph1 = 'This application simulates a Pokédex,';
  const paragraph1 = queryByText(
    `${textParagraph1} a digital encyclopedia containing all Pokémons`,
  );
  const paragraph2 = queryByText(
    'One can filter Pokémons by type, and see more details for each one of them',
  );
  const informationAboutThePokedex = [paragraph1, paragraph2];
  informationAboutThePokedex.forEach((element) => {
